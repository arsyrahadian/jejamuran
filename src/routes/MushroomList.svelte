...
<section id="jenis" class="wrapper">
  ...
  <div class="video-container">
    <div class="video">
      <iframe
        src="https://www.youtube-nocookie.com/embed/X_zjCBjkj6w"
...
<style>
  ...
  .list-item:nth-child(4n + 1) .list-title > *,
  .list-item:nth-child(4n) .list-title > * {
    background-color: var(--clr-accent);
  }

  .list-item:nth-child(4n + 3) .list-title > *,
  .list-item:nth-child(4n + 2) .list-title > * {
